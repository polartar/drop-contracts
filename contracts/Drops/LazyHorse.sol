...
contract LazyHorse is BaseDrop {
    using Counters for Counters.Counter;
    using SafePct for uint256;
    using SafeMathLite for uint256;
    Counters.Counter public _tokenIdCounter;

    uint256 private MAX_TOKENS = 2000;
    ...
    constructor(address _memberships, address _artist) ERC721("Lazy Horse", "HORSE") {
